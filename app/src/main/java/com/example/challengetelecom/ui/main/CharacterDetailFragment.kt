...
import com.example.challengetelecom.util.gone
import com.example.challengetelecom.util.visible
...
class CharacterDetailFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        binding.apply {
            ...
            } ?: kotlin.run { itemDetailContainer.gone() }
        }
